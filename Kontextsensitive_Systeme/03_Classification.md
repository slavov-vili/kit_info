...
1. Step 2 = Feature Extraction
    ...
    - Weight or roundness to separate apples from oranges
    - Good Features
    - Color for apples and oranges
...
1. Decision Tree (see image)
    ...
    - Metrics for splits
        ...
        * something with entropy and stuff
...
1. Support Vector Machines (SVM)
    ...
    - Finding optimal = convex constraint optimization problem with defined solution
...
1. Perceptron
    ...
    - Multi-layer perceptron (see image)
